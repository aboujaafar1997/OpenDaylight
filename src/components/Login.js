    ...
    return (
        <div className="container text-center mt-5 login">
            ...
            <div className="mt-5">
                ...
                <button type="submit" className="btn btn-primary offset-1 mb-2" onClick={() => { props.dispatch({ user: cin.current.value, password: password.current.value }) }}>Connectez-vous!</button>
            </div>
        </div>
    )
}
